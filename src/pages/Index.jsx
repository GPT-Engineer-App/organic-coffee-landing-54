...
const ServiceCard = ({ icon: Icon, title, description }) => {
  return (
    <VStack bg="gray.100" p={6} borderRadius="md" boxShadow="md" spacing={4} align="center" textAlign="center" border="2px solid" borderColor={title === "Fresh Coffee" ? "brown.600" : title === "Organic Teas" ? "green.600" : title === "Coffee Equipment" ? "brown.800" : title === "Shop" ? "brown.600" : "green.200"}>
