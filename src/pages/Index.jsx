...
const Testimonial = ({ name, content, gender }) => {
  const avatarUrl = name === "Leon Che" ? "https://eu.ui-avatars.com/api/?name=Leon+Che&background=8D6E63&color=fff&rounded=true" : name === "Anna Johansson" ? "https://i.pravatar.cc/150?img=44" : "https://i.pravatar.cc/150?img=47";
  return (
