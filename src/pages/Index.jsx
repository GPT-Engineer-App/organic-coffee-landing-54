...
const Testimonial = ({ name, content, gender }) => {
  ...
  return (
    <VStack bg="gray.100" pt={32} pb={6} px={6} borderRadius="md" boxShadow="md" spacing={4} align="center" textAlign="center" borderBottom="5px solid" borderColor={name === "Leon Che" ? "green.600" : name === "Anna Johansson" ? "#A0522D" : "green.600"} position="relative">
      <Avatar size="xl" name={name} src={avatarUrl} position="absolute" top="-40px" left="50%" transform="translateX(-50%)" />
